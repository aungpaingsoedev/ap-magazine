  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <h1 className="font-display mt-2 text-3xl font-black">SEO defaults</h1>
        <p className="mt-2 max-w-xl text-sm text-neutral-600">
          These values are used when an article does not set its own SEO fields.
          Per-article SEO is edited in the article editor.
        </p>
      </div>
